...
import { PrivacyPolicyContainer } from "../../ui/styles/PrivacyPolicy/PrivacyPolicy.styles";
  ...
  return (
    <PrivacyPolicyContainer>
      <Container>
        ...
        <p>
          A sua privacidade é importante para nós. É política do HastyDEV
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site <a href="https://hasty-dev.vercel.app">HastyDEV</a>, e outros sites
        ...
        <p>
          ...
          informação que o HastyDEV oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            (softwares) do HastyDEV, de seus fornecedores ou terceiros, para
        ...
        <p>Esta política é efetiva a partir de&nbsp;22 March 2024 22:59</p>
      </Container>
    </PrivacyPolicyContainer>
  );
};
